 ...
 * @return Error code
 */
int dwm_pos_get(SPI_HandleTypeDef* spiHandle, dwm_pos_t* pos);
 ...
 * @return Error code
 */
int dwm_upd_rate_set(SPI_HandleTypeDef* spiHandle, uint16_t ur, uint16_t urs);
 ...
 * @return Error code
 */
int dwm_upd_rate_get(SPI_HandleTypeDef* spiHandle, uint16_t *ur, uint16_t *urs);
 ...
 * @return Error code
 */
int dwm_baddr_set(SPI_HandleTypeDef* spiHandle, dwm_baddr_t* baddr);
 ...
 * @return Error code
 */
int dwm_baddr_get(SPI_HandleTypeDef* spiHandle, dwm_baddr_t* baddr);
 ...
 * @return Error code
 */
int dwm_reset(SPI_HandleTypeDef*);
 ...
 * @return Error code
 */
int dwm_gpio_value_get(SPI_HandleTypeDef* spiHandle, dwm_gpio_idx_t idx, bool* value);
