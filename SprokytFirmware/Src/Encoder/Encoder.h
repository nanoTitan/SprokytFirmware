...
#define ENCODER_COUNT_MAX_WRAP_CHECK		1600			// A max threshold to see if the count wrapped around
#define ENCODER_COUNT_MIN_WRAP_CHECK		100				// A min threshold to see if the count wrapped around
